...
class ListAvisClients extends StatefulWidget {

  const ListAvisClients({
    Key? key
  }) : super(key: key);

  @override
  State<ListAvisClients> createState() => ListAvisClientsState();

}

class ListAvisClientsState extends State<ListAvisClients> {

  final String? profilePic, name, comment, date;
  final int? evaluation, order;
  ListAvisClientsState({this.profilePic, this.name,this.evaluation,this.comment,this.date,this.order});
